        ...
        >
          ...
          >
            <ShinyText
              ...
              className="text-3xl md:text-5xl  font-bold bg-linear-to-r from-purple-500 to-pink-500 bg-clip-text block mb-2"
            />
          ...
          <div className="space-y-6">
            ...
            >
              <label className="block text-sm font-medium text-gray-300 mb-2">
                <ShinyText text="Recipe Title" speed={3} className="text-2xl" />
              </label>
              <input
                type="text"
                {...register("title")}
                placeholder="Enter title of Recipe"
                className="ease-out hover:scale-103 hover:shadow-2xl hover:shadow-purple-500/40 w-full p-4 bg-black/50 border border-purple-500/30 rounded-xl text-white placeholder-gray-400 focus:border-purple-500/75 focus:ring-2 focus:ring-purple-500/20 transition-all duration-300 backdrop-blur-sm"
              />
            </motion.div>
            ...
            >
              ...
              <input
                ...
                className="hover:scale-103 hover:shadow-2xl hover:shadow-purple-500/40 w-full p-4 bg-black/50 border border-purple-500/30 rounded-xl text-white placeholder-gray-400 focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition-all duration-300 backdrop-blur-sm"
              />
            </motion.div>
            ...
            >
              <label className="block text-sm font-medium text-gray-300 mb-2">
                <ShinyText text="Description" speed={3} className="text-2xl" />
              </label>
              <textarea
                {...register("description")}
                placeholder="Description of Recipe"
                rows="3"
                className="hover:scale-103 hover:shadow-2xl hover:shadow-purple-500/40 w-full p-4 bg-black/50 border border-purple-500/30 rounded-xl text-white placeholder-gray-400 focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition-all duration-300 backdrop-blur-sm resize-none"
              />
            </motion.div>
            ...
            <motion.div
              ...
              className="bg-black/30 hover:scale-103 hover:shadow-2xl hover:shadow-purple-500/40 p-6 rounded-2xl border border-purple-500/20"
            >
              <label className="block text-sm font-medium text-gray-300 mb-2">
                <ShinyText
                  text="Ingredients"
            ...
            >
              <label className="block text-sm font-medium text-gray-300 mb-2">
                <ShinyText text="Instructions" speed={3} className="text-2xl" />
              </label>
              <textarea
                {...register("instruction")}
                placeholder="Instruction of Recipe"
                rows="4"
                className="hover:scale-103 hover:shadow-2xl hover:shadow-purple-500/40 w-full p-4 bg-black/50 border border-purple-500/30 rounded-xl text-white placeholder-gray-400 focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition-all duration-300 backdrop-blur-sm resize-none"
              />
            </motion.div>
            ...
            >
              ...
              <select
                name="Categories"
                {...register("category")}
                className="hover:scale-103 hover:shadow-2xl hover:shadow-purple-500/40 w-full p-4 bg-black/50 border border-purple-500/30 rounded-xl text-white focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition-all duration-300 backdrop-blur-sm appearance-none"
              >
                ...
                <optgroup label="By Dish Type" className="bg-gray-800">
                  <option value="soup" className="bg-gray-800">
                    Soup
                  </option>
                  <option value="salad" className="bg-gray-800">
                    Salad 🥗
                  </option>
                  <option value="baking" className="bg-gray-800">
                    Baking
                  </option>
                  <option value="drink" className="bg-gray-800">
                    Drink / Beverage 🍹
                  </option>
                  <option value="sauce" className="bg-gray-800">
                    Sauce / Condiment
                  </option>
                </optgroup>
                ...
                <optgroup label="By Cuisine" className="bg-gray-800">
                  <option value="indian" className="bg-gray-800">
                    Indian
                  </option>
                  <option value="italian" className="bg-gray-800">
                    Italian 🍝
                  </option>
                  <option value="mexican" className="bg-gray-800">
                    Mexican
                  </option>
            ...
            >
              <label className="block text-sm font-medium text-gray-300 mb-2">
                <ShinyText text="Chef's Name" speed={3} className="text-2xl" />
              </label>
              <input
                type="text"
                {...register("chef")}
            ...
            >
              <Magnet padding={50} magnetStrength={15}>
                <button
                  ...
                  className="hover:shadow-2xl p-2 focus:bg-blue-500 cursor-pointer hover:shadow-green-500/40 w-full py-4 bg-linear-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-bold text-lg rounded-2xl transition-all duration-300 transform hover:scale-105"
                >
                  <ShinyText
                    text="Save Recipe"
                    speed={2}
